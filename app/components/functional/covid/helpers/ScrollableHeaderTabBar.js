...
class ScrollableTabs extends React.Component{
    ...
    componentWillMount() {
        if (this.props.activeTab !== undefined && this.props.activeTab !== this.state.activeTab) {
            // console.log("Tab is not ctive tab:", this.props.activeTab, this.state.activeTab);
    ...
    _updateView(offset) {
    //   console.log("Inside  _updateView");
        ...
        if (this.necessarilyMeasurementsCompleted(position, position === lastTabPosition)) {
            // console.log("Calling necessarilyMeasurementsCompleted");
        ...
        if (activePosition !== this.state.activeTab) {
            ...
            // console.log("Udating activeTab to :", activePosition);
        }
    }

    necessarilyMeasurementsCompleted(position, isLastTab) {
        // console.log("position", isLastTab);
    ...
    measureTab(page, event) {
        // console.log("Inside measureTab", page, event);
        ...
        // console.log("MeasureTab scrollvalue:", this.scrollValue._value );
    ...
    >
        {this.props.tabs.map((name, page) => {
            ...
            // console.log("Is tab actiive:",isTabActive, this.state.activeTab, page);
